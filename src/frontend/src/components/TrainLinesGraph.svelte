...
>
    <div class="flex gap-2 place-content-between">
        <div>
            <p class="text-lg text-bold text-neutral-100">Delays per Line</p>
            <p class="text-md italic text-neutral-400">On Average</p>

            <p class="text-neutral-300">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum
                dolor neque minus minima vitae cumque omnis, fugiat laudantium
                velit similique reiciendis iusto! Dolorum deserunt unde est,
                blanditiis doloremque exercitationem reiciendis.
            </p>
        </div>
